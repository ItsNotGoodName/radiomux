...
type TimelineWindow struct {
	...
	PresentationStartTimeMs      int64 `protobuf:"varint,1,opt,name=presentation_start_time_ms,json=presentationStartTimeMs,proto3" json:"presentation_start_time_ms,omitempty"`
	WindowStartTimeMs            int64 `protobuf:"varint,2,opt,name=window_start_time_ms,json=windowStartTimeMs,proto3" json:"window_start_time_ms,omitempty"`
	ElapsedRealtimeEpochOffsetMs int64 `protobuf:"varint,3,opt,name=elapsed_realtime_epoch_offset_ms,json=elapsedRealtimeEpochOffsetMs,proto3" json:"elapsed_realtime_epoch_offset_ms,omitempty"`
	IsSeekable                   bool  `protobuf:"varint,4,opt,name=is_seekable,json=isSeekable,proto3" json:"is_seekable,omitempty"`
	...
	DefaultPositionMs            int64 `protobuf:"varint,8,opt,name=default_position_ms,json=defaultPositionMs,proto3" json:"default_position_ms,omitempty"`
	DurationMs                   int64 `protobuf:"varint,9,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
}

func (x *TimelineWindow) Reset() {
	*x = TimelineWindow{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimelineWindow) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimelineWindow) ProtoMessage() {}

func (x *TimelineWindow) ProtoReflect() protoreflect.Message {
	mi := &file_shared_message_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimelineWindow.ProtoReflect.Descriptor instead.
func (*TimelineWindow) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{5}
}

func (x *TimelineWindow) GetPresentationStartTimeMs() int64 {
	if x != nil {
		return x.PresentationStartTimeMs
	}
	return 0
}

func (x *TimelineWindow) GetWindowStartTimeMs() int64 {
	if x != nil {
		return x.WindowStartTimeMs
	}
	return 0
}

func (x *TimelineWindow) GetElapsedRealtimeEpochOffsetMs() int64 {
	if x != nil {
		return x.ElapsedRealtimeEpochOffsetMs
	}
	return 0
}

func (x *TimelineWindow) GetIsSeekable() bool {
	if x != nil {
		return x.IsSeekable
	}
	return false
...
func (x *TimelineWindow) GetIsDynamic() bool {
	if x != nil {
		return x.IsDynamic
	}
	return false
...
func (x *TimelineWindow) GetIsLive() bool {
	if x != nil {
		return x.IsLive
	}
	return false
...
func (x *TimelineWindow) GetIsPlaceholder() bool {
	if x != nil {
...
func (x *TimelineWindow) GetDefaultPositionMs() int64 {
	if x != nil {
		return x.DefaultPositionMs
	}
	return 0
}

func (x *TimelineWindow) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *PositionInfo) GetPositionMs() int64 {
	if x != nil {
		return x.PositionMs
	}
	return 0
...
type Event struct {
	...
	//	*Event_OnTimelineChanged
	//	*Event_OnPositionChanged
...
func (x *Event) GetOnTimelineChanged() *OnTimelineChanged {
	if x, ok := x.GetPayload().(*Event_OnTimelineChanged); ok {
		return x.OnTimelineChanged
	}
	return nil
}

func (x *Event) GetOnPositionChanged() *OnPositionChanged {
	if x, ok := x.GetPayload().(*Event_OnPositionChanged); ok {
		return x.OnPositionChanged
	}
	return nil
}
...
type Event_OnTimelineChanged struct {
	OnTimelineChanged *OnTimelineChanged `protobuf:"bytes,13,opt,name=OnTimelineChanged,proto3,oneof"`
}

type Event_OnPositionChanged struct {
	OnPositionChanged *OnPositionChanged `protobuf:"bytes,14,opt,name=OnPositionChanged,proto3,oneof"`
}
...
func (*Event_OnTimelineChanged) isEvent_Payload() {}

func (*Event_OnPositionChanged) isEvent_Payload() {}
...
type OnTimelineChanged struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Window    *TimelineWindow `protobuf:"bytes,1,opt,name=window,proto3" json:"window,omitempty"`
	TimeUnset int64           `protobuf:"varint,2,opt,name=time_unset,json=timeUnset,proto3" json:"time_unset,omitempty"`
}

func (x *OnTimelineChanged) Reset() {
	*x = OnTimelineChanged{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnTimelineChanged) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnTimelineChanged) ProtoMessage() {}

func (x *OnTimelineChanged) ProtoReflect() protoreflect.Message {
	mi := &file_shared_message_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnTimelineChanged.ProtoReflect.Descriptor instead.
func (*OnTimelineChanged) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{20}
}

func (x *OnTimelineChanged) GetWindow() *TimelineWindow {
	if x != nil {
		return x.Window
	}
	return nil
...
func (x *OnTimelineChanged) GetTimeUnset() int64 {
	if x != nil {
		return x.TimeUnset
	}
	return 0
...
type OnPositionChanged struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OldPosition *PositionInfo `protobuf:"bytes,1,opt,name=old_position,json=oldPosition,proto3" json:"old_position,omitempty"`
	NewPosition *PositionInfo `protobuf:"bytes,2,opt,name=new_position,json=newPosition,proto3" json:"new_position,omitempty"`
	Timestamp   string        `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
}

func (x *OnPositionChanged) Reset() {
	*x = OnPositionChanged{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnPositionChanged) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnPositionChanged) ProtoMessage() {}

func (x *OnPositionChanged) ProtoReflect() protoreflect.Message {
	mi := &file_shared_message_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnPositionChanged.ProtoReflect.Descriptor instead.
func (*OnPositionChanged) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{21}
}

func (x *OnPositionChanged) GetOldPosition() *PositionInfo {
	if x != nil {
...
func (x *OnPositionChanged) GetNewPosition() *PositionInfo {
	if x != nil {
...
func (x *OnPositionChanged) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
func (x *DecreaseDeviceVolume) Reset() {
	*x = DecreaseDeviceVolume{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_message_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DecreaseDeviceVolume) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{32}
}
...
func (x *SetDeviceMuted) Reset() {
	*x = SetDeviceMuted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_message_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDeviceMuted) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{33}
}
...
func (x *SyncState) Reset() {
	*x = SyncState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_message_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncState) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{34}
}
...
func (x *SeekToDefaultPosition) Reset() {
	*x = SeekToDefaultPosition{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_message_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SeekToDefaultPosition) Descriptor() ([]byte, []int) {
	return file_shared_message_proto_rawDescGZIP(), []int{35}
}
...
var file_shared_message_proto_rawDesc = []byte{
	...
	0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x22, 0xf3, 0x07, 0x0a, 0x0d, 0x4d,
	...
	,
	...
	,
	...
	0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x45, 0x0a, 0x15, 0x4f,
	0x6e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x18, 0x01,
	...
	,
	...
	,
...
var file_shared_message_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_shared_message_proto_goTypes = []interface{}{
	...
	(*TimelineWindow)(nil),              // 5: TimelineWindow
	(*PositionInfo)(nil),                // 6: PositionInfo
	(*Event)(nil),                       // 7: Event
	(*RpcReply)(nil),                    // 8: RpcReply
	(*OnMediaMetadataChanged)(nil),      // 9: OnMediaMetadataChanged
	(*OnPlaylistMetadataChanged)(nil),   // 10: OnPlaylistMetadataChanged
	(*OnIsLoadingChanged)(nil),          // 11: OnIsLoadingChanged
	(*OnPlaybackStateChanged)(nil),      // 12: OnPlaybackStateChanged
	(*OnIsPlayingChanged)(nil),          // 13: OnIsPlayingChanged
	(*OnPlayerError)(nil),               // 14: OnPlayerError
	(*OnPlaybackParametersChanged)(nil), // 15: OnPlaybackParametersChanged
	(*OnVolumeChanged)(nil),             // 16: OnVolumeChanged
	(*OnDeviceInfoChanged)(nil),         // 17: OnDeviceInfoChanged
	(*OnDeviceVolumeChanged)(nil),       // 18: OnDeviceVolumeChanged
	(*OnCurrentUriChanged)(nil),         // 19: OnCurrentUriChanged
	(*OnTimelineChanged)(nil),           // 20: OnTimelineChanged
	(*OnPositionChanged)(nil),           // 21: OnPositionChanged
	(*Rpc)(nil),                         // 22: Rpc
	(*Stop)(nil),                        // 23: Stop
	(*Play)(nil),                        // 24: Play
	(*Pause)(nil),                       // 25: Pause
	(*Prepare)(nil),                     // 26: Prepare
	(*SetPlayWhenReady)(nil),            // 27: SetPlayWhenReady
	(*SetMediaItem)(nil),                // 28: SetMediaItem
	(*SetVolume)(nil),                   // 29: SetVolume
	(*SetDeviceVolume)(nil),             // 30: SetDeviceVolume
	(*IncreaseDeviceVolume)(nil),        // 31: IncreaseDeviceVolume
	(*DecreaseDeviceVolume)(nil),        // 32: DecreaseDeviceVolume
	(*SetDeviceMuted)(nil),              // 33: SetDeviceMuted
	(*SyncState)(nil),                   // 34: SyncState
	(*SeekToDefaultPosition)(nil),       // 35: SeekToDefaultPosition
}
var file_shared_message_proto_depIdxs = []int32{
	...
	8,  // 2: Event.RpcReply:type_name -> RpcReply
	9,  // 3: Event.OnMediaMetadataChanged:type_name -> OnMediaMetadataChanged
	10, // 4: Event.OnPlaylistMetadataChanged:type_name -> OnPlaylistMetadataChanged
	11, // 5: Event.OnIsLoadingChanged:type_name -> OnIsLoadingChanged
	12, // 6: Event.OnPlaybackStateChanged:type_name -> OnPlaybackStateChanged
	13, // 7: Event.OnIsPlayingChanged:type_name -> OnIsPlayingChanged
	14, // 8: Event.OnPlayerError:type_name -> OnPlayerError
	15, // 9: Event.OnPlaybackParametersChanged:type_name -> OnPlaybackParametersChanged
	16, // 10: Event.OnVolumeChanged:type_name -> OnVolumeChanged
	17, // 11: Event.OnDeviceInfoChanged:type_name -> OnDeviceInfoChanged
	18, // 12: Event.OnDeviceVolumeChanged:type_name -> OnDeviceVolumeChanged
	19, // 13: Event.OnCurrentUriChanged:type_name -> OnCurrentUriChanged
	20, // 14: Event.OnTimelineChanged:type_name -> OnTimelineChanged
	21, // 15: Event.OnPositionChanged:type_name -> OnPositionChanged
	1,  // 16: OnMediaMetadataChanged.media_metadata:type_name -> MediaMetadata
	1,  // 17: OnPlaylistMetadataChanged.media_metadata:type_name -> MediaMetadata
	2,  // 18: OnPlayerError.error:type_name -> PlaybackException
	3,  // 19: OnPlaybackParametersChanged.playback_parameters:type_name -> PlaybackParameters
	4,  // 20: OnDeviceInfoChanged.device_info:type_name -> DeviceInfo
	5,  // 21: OnTimelineChanged.window:type_name -> TimelineWindow
	6,  // 22: OnPositionChanged.old_position:type_name -> PositionInfo
	6,  // 23: OnPositionChanged.new_position:type_name -> PositionInfo
	23, // 24: Rpc.Stop:type_name -> Stop
	24, // 25: Rpc.Play:type_name -> Play
	25, // 26: Rpc.Pause:type_name -> Pause
	26, // 27: Rpc.Prepare:type_name -> Prepare
	27, // 28: Rpc.SetPlayWhenReady:type_name -> SetPlayWhenReady
	28, // 29: Rpc.SetMediaItem:type_name -> SetMediaItem
	29, // 30: Rpc.SetVolume:type_name -> SetVolume
	30, // 31: Rpc.SetDeviceVolume:type_name -> SetDeviceVolume
	31, // 32: Rpc.IncreaseDeviceVolume:type_name -> IncreaseDeviceVolume
	32, // 33: Rpc.DecreaseDeviceVolume:type_name -> DecreaseDeviceVolume
	33, // 34: Rpc.SetDeviceMuted:type_name -> SetDeviceMuted
	34, // 35: Rpc.SyncState:type_name -> SyncState
	35, // 36: Rpc.SeekToDefaultPosition:type_name -> SeekToDefaultPosition
...
func file_shared_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shared_message_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnTimelineChanged); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_shared_message_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnPositionChanged); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_shared_message_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_message_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_message_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_message_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
	...
	file_shared_message_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*Event_RpcReply)(nil),
		...
		(*Event_OnTimelineChanged)(nil),
		(*Event_OnPositionChanged)(nil),
	}
	file_shared_message_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*Rpc_Stop)(nil),
		(*Rpc_Play)(nil),
		(*Rpc_Pause)(nil),
		(*Rpc_Prepare)(nil),
